  ...
  module.exports.sendEmail = async (req, res, next) => {
    ...
    try {
        ...
        function transformLinks(emailBody, receiverId, myServerDomain, emailID, encode = true) {
            ...
            transformedBody = transformedBody + `<img alt="sorry" src='${process.env.DOMAIN.toString()}/${campaign._id.toString()}/${receiverId.toString()}/tracker.png' class="CToWUd" data-bit="iit"></img>`;
